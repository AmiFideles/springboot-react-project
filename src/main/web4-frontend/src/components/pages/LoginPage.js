    ...
    return (
        <div className='h-75 mt-5 container d-flex justify-content-center align-items-center'>
            <Form style={{width: 400}}
                  className="w-30 shadow p-3 mb-5 bg-secondary text-white rounded"
            ...
            >
                ...
                <div className="text-white text-center mt">
                    Don't have an account yet? <Link className='text-white' to="/register">Sign Up</Link>
                </div>
