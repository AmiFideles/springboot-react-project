...
const Graph = ({width = 100, height = 100}) => {
    ...
    return (
        ...
        <div
            ...
            style={{width, height}}
        >
            <svg className="svg-graph bg-body" style={rValue?{border: "red solid", cursor: "crosshair"}:{border: "black solid",  cursor: "crosshair" }}  viewBox="0 0 300 300" xmlns="http://www.w3.org/2000/svg">
                circle

                <path className="graph-shape" d="M 100 150
                  A 50, 50, 0, 0, 0, 150 200
                  L 150 150
                  Z" fill="#5ba8ef" fillOpacity="0.5"/>

                <polygon className="graph-shape" points="150,250 150,150 200,150" fill="#5ba8ef" fillOpacity="0.5"/>

                <polygon className="graph-shape" points="50,150 50,100 150,100 150,150" fill="#5ba8ef"
                         fillOpacity="0.5"/>
